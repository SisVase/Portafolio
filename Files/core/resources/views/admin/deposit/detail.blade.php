...
@section('panel')
    <div class="row mb-none-30">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group mb-4">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Name')
                            <span class="font-weight-bold">{{ __($deposit->invoice->name) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Email')
                            <span class="font-weight-bold">{{ __($deposit->invoice->email) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Phone')
                            <span class="font-weight-bold">{{ $deposit->invoice->phone }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Order')
                            <span class="font-weight-bold"><a href="{{ route('admin.order.details', $deposit->invoice->id) }}">@lang('View Details')</a></span>
                        </li>
                    </ul>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Order Tracking Number')
                            <span class="font-weight-bold">{{ $deposit->invoice->track_id }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Discount')
                            <span class="font-weight-bold">{{ showAmount($deposit->invoice->discount ) }} {{ __($general->cur_text) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('After Charge')
        ...
        <div class="col-xl-8 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">@lang('Customer Payment Information')</h5>
                    @if($details != null)
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.deposit.approve')}}" method="POST">
                ...
                <div class="modal-body">
                    <p>@lang('Are you sure to') <span class="font-weight-bold">@lang('approve')</span> <span class="font-weight-bold withdraw-amount text-success"></span> @lang('payment of') <span class="font-weight-bold withdraw-user"></span>?</p>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.deposit.reject')}}" method="POST">
                ...
                <input type="hidden" name="id">
                <div class="modal-body">
                    <p>@lang('Are you sure to') <span class="font-weight-bold">@lang('reject')</span> <span class="font-weight-bold withdraw-amount text-success"></span> @lang('payment of') <span class="font-weight-bold withdraw-user"></span>?</p>
