                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Offer Notice') <code>@lang('Like: Get Up to 40% OFF New-Season Styles')</code></label>
                                    <input class="form-control form-control-lg" type="text" name="offer" value="{{$general->offer}}">
                                </div>
                            </div> 
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('Dark Template')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="dark" @if($general->dark) checked @endif>
                            </div>
                            <div class="form-group col-md-3">
