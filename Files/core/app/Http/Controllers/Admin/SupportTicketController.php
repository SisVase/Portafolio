...
class SupportTicketController extends Controller
{
    public function tickets()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $emptyMessage = 'No Data found.';
        $items = SupportTicket::whereIn('status', [0,2])->orderBy('priority', 'DESC')->orderBy('id','desc')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle','emptyMessage'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::where('status',3)->orderBy('id','desc')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle','emptyMessage'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $emptyMessage = 'No Data found.';
        $items = SupportTicket::orderBy('id','desc')->where('status',1)->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle','emptyMessage'));
    }
